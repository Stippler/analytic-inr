...
def plot_cell_sdf(
    ...
    if net.input_dim != 2:
        print(f"Warning: plot_cell_sdf3 expects 2D input, got input_dim={net.input_dim}")
        return
...
def plot_sdf_heatmap(net, splines=None, polygons=None, resolution=300, device=None, 
                     highlight_idx=None, title=None, save_path=None):
    """
    ...
    if net.input_dim != 2:
        print(f"Warning: expects 2D input, got input_dim={net.input_dim}")
        return
